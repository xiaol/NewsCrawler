...
from Extractors.Parse_nphoto import Parser
...
class ContentSpiderNphoto(Spider):

    name = 'content_spider_nphoto'
    qname = 'nphoto:content'
    pool = redis.ConnectionPool(host='localhost', port=6379, db=0)
    r = redis.Redis(connection_pool=pool)

    # start_urls = [
    #     'http://www.nphoto.net/news/2011-09/01/e9cfc4d826212eca.shtml',
    # ]
