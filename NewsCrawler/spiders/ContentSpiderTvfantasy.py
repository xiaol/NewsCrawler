...
from Extractors.Parse_tvfantasy import Parser
...
class ContentSpiderTvfantasy(Spider):

    name = 'content_spider_tvfantasy'
    qname = 'tvfantasy:content'
    pool = redis.ConnectionPool(host='localhost', port=6379, db=0)
    r = redis.Redis(connection_pool=pool)

    # start_urls = [
    #     'http://tvfantasy.net/2015/06/24/todays-tv-news-guide-2015-06-24/',
    # ]
