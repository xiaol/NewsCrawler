...
class Parser(object):
    ...
    def get_content(cls, url, root):
        ...
        attrs = [
            {'attr': 'class', 'value': 'art-body'},
            {'attr': 'class', 'value': 'art-gallery-body'},
            # 'article',
                 ]
    ...
    def cont_format(node):
        ...
        for child in node.iter():
            ...
            # tags filter
            if 'class' in child.attrib and child.attrib['class'] == 'art-body':
                continue
            if 'id' in child.attrib and child.attrib['id'] == 'J_loading':
                break
