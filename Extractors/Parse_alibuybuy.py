...
class Parser(object):
    ...
    def get_content(cls, url, root):
        ...
        attrs = [{'attr': 'class', 'value': 'article-content'},
                 ]
    ...
    def cont_format(node):
        ...
        for child in node.iter():
            ...
            # tags filter
            if 'class' in child.attrib and child.attrib['class'] == 'article-content':
                continue
            if 'class' in child.attrib and child.attrib['class'] == 'clearfix':
                break
